...
class User_model extends CI_Model {
    ...
    public function checkLoginParent($data) {
     ...
     public function read_user_information($users_id) {
        $this->db->select('users.*,students.firstname,students.image,students.lastname,students.guardian_name,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section');
        $this->db->from('users');
