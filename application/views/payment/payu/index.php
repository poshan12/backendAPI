    ...
    <div class="container">
      <div class="row">
       <div class="col-md-12">
        <div class="paybox">
          <div class="paybox_bg">
    <h3 class="bt_title"><img src="../backend/images/paym.jpg" style="margin-bottom: 10px;"><br />PayU Payment Gateway</h3>
    <div class="paybody">
    <?php if ($formError) {?>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" id="payuForm">
      ...
      <div class="form-group row">
          <label class="col-sm-4">Amount <span class="text text-danger">*</span></label>
           <div class="col-sm-8"><input class="form-control" name="amount" value="<?php echo set_value('amount', $session_params['total']) ?>" readonly="readonly"/></div>
      </div><!--./form-group-->
       <div class="form-group row">
