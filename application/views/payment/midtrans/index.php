                ...
                <div class="paddtop20">
                            ...
                            <div class="padd2 paddtzero">
                                ...
                                <table class="table2" width="100%">
                                    ...
                                    <tr class="bordertoplightgray">
                                        <td  bgcolor="#fff">  </td>
                                        <td  bgcolor="#fff" class="text-right"> <button type="button"  name="search" id="pay-button"  value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Midtrans'); ?></button>  </td>
                                    </tr>
                                </table>
