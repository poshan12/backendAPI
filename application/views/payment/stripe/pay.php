...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="paybox">
				<div class="paybox_bg">
				<h3 class="bt_title"><img src="../backend/images/paym.png" style="margin-bottom: 10px;"><br />Stripe Payment Gateway</h3>
				<div class="paybody">
				<div class="dropin-page">
				 ...
				 <div class="form-group row">
				 	...
				 	<div class="col-sm-8">
				 	 <div class="form-control"><?php echo $session_params['invoice']->symbol."".$session_params['total'];?></div>
